...
namespace STARK
{
    public class CargarGramaticas : Variables
    {
        ...
        public void SeleccionarComandos()
        {
            try
            {
                con = new OleDbConnection(Settings.Default.ConexionBD);
                con.Open();
                cmd = new OleDbCommand("SELECT Comando FROM CmdSociales", con);
                ...
                cmd = new OleDbCommand("SELECT Comando FROM CmdCarpetas", con);
                readerS = cmd.ExecuteReader();
                while (readerS.Read())
                {
                    comandos = readerS["Comando"].ToString().Split(new char[] { '+' });
                ...
                cmd = new OleDbCommand("SELECT Comando FROM CmdAplicaciones", con);
                readerS = cmd.ExecuteReader();
                while (readerS.Read())
                {
                    comandos = readerS["Comando"].ToString().Split(new char[] { '+' });
                ...
                cmd = new OleDbCommand("SELECT Comando FROM CmdPaginasWebs", con);
                readerS = cmd.ExecuteReader();
                while (readerS.Read())
                {
                    comandos = readerS["Comando"].ToString().Split(new char[] { '+' });
                ...
                cmd = new OleDbCommand("SELECT Comando FROM CmdInternos", con);
                readerS = cmd.ExecuteReader();
                while (readerS.Read())
                {
                    comandos = readerS["Comando"].ToString().Split(new char[] { '+' });
                ...
                cmd = new OleDbCommand("SELECT Sinonimo FROM CmdInternos", con);
                readerS = cmd.ExecuteReader();
                while (readerS.Read())
                {
                ...
                cmd = new OleDbCommand("SELECT Comando FROM CmdPuertoSerial", con);
                readerS = cmd.ExecuteReader();
                while (readerS.Read())
                {
                    comandos = readerS["Comando"].ToString().Split(new char[] { '+' });
